...
<body>
        ...
        <div class="container header-content">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="index.html">เข้าสู่ระบบผู้ดูแล</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <!-- แก้ไข Hero Section -->
        ...
        <h1>รายงานการสรุปการฝึกประสบการณ์</h1>
        <h2>รายงานการฝึกงาน</h2>
        <p>วิทยาลัยการอาชีพปราสาท - งานกิจกรรม</p>
        <div class="duration-box">
            <p>ระยะเวลาการฝึกงาน: 1 มีนาคม - 30 เมษายน 2567</p>
        </div>
    </div>
</section>
        ...
        <!-- Page 4: Duties -->
        <section id="duties" class="slide">
            <div class="slide-header">
                <div class="slide-number">3</div>
                <h2 class="slide-title">หน้าที่และกิจกรรมหลัก</h2>
            </div>
            <div class="slide-content">
                <ol>
                    <li><span class="highlight">ดูแลน้องสรรตบรรณ</span> - การจัดการเอกสารและหนังสือราชการภายในแผนก</li>
                    <li><span class="highlight">เดินเอกสาร</span> - การรับ-ส่งเอกสารระหว่างหน่วยงานภายในวิทยาลัย</li>
                    <li><span class="highlight">ช่วยคิดกิจกรรม</span> - การเสนอแนวคิดและออกแบบกิจกรรมสำหรับนักศึกษา</li>
                    <li>ประสานงานการจัดกิจกรรมต่างๆ ของนักศึกษา</li>
                    <li>จัดเตรียมสถานที่และอุปกรณ์สำหรับกิจกรรม</li>
                    <li>บันทึกข้อมูลและจัดทำรายงานผลการจัดกิจกรรม</li>
                </ol>
                
                <div class="gallery">
                    <div class="gallery-item">
                        <img src="https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?ixlib=rb-4.0.3&auto=format&fit=crop&w=500" alt="งานเอกสาร">
                        <div class="gallery-caption">งานเอกสารและหนังสือราชการ</div>
                    </div>
                    <div class="gallery-item">
                        <img src="https://images.unsplash.com/photo-1553877522-43269d4ea984?ixlib=rb-4.0.3&auto=format&fit=crop&w=500" alt="กิจกรรมนักศึกษา">
                        <div class="gallery-caption">การจัดกิจกรรมนักศึกษา</div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- Page 5: Time Period -->
        <section id="time" class="slide">
            <div class="slide-header">
                <div class="slide-number">4</div>
                <h2 class="slide-title">ระยะเวลาการฝึกงาน</h2>
            </div>
            <div class="slide-content">
                <div class="stats-container">
                    <div class="stat-card">
                        <div class="stat-value">1 มีนาคม 2567</div>
                        <div class="stat-label">วันเริ่มฝึกงาน</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-value">30 เมษายน 2567</div>
                        <div class="stat-label">วันสิ้นสุดฝึกงาน</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-value">45 วัน</div>
                        <div class="stat-label">ระยะเวลาจริง (ไม่รวมวันหยุด)</div>
                    </div>
                </div>
                
                <h3>บันทึกการเข้างาน-ออกงาน (ตัวอย่าง)</h3>
                <div style="overflow-x: auto;">
                    <table style="width: 100%; border-collapse: collapse; margin: 1.5rem 0;">
                        <thead>
                            <tr style="background-color: var(--primary); color: white;">
                                <th style="padding: 12px; text-align: left;">วันที่</th>
                                <th style="padding: 12px; text-align: left;">เวลาเข้างาน</th>
                                <th style="padding: 12px; text-align: left;">เวลาออกงาน</th>
                                <th style="padding: 12px; text-align: left;">กิจกรรมหลัก</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr style="border-bottom: 1px solid #eee;">
                                <td style="padding: 12px;">1 มี.ค. 2567</td>
                                <td style="padding: 12px;">08:30</td>
                                <td style="padding: 12px;">16:30</td>
                                <td style="padding: 12px;">ปฐมนิเทศ, รับทราบหน้าที่</td>
                            </tr>
                            <tr style="border-bottom: 1px solid #eee; background-color: #f9f9f9;">
                                <td style="padding: 12px;">4 มี.ค. 2567</td>
                                <td style="padding: 12px;">08:45</td>
                                <td style="padding: 12px;">17:00</td>
                                <td style="padding: 12px;">ช่วยจัดเตรียมเอกสารกิจกรรม</td>
                            </tr>
                            <tr style="border-bottom: 1px solid #eee;">
                                <td style="padding: 12px;">15 มี.ค. 2567</td>
                                <td style="padding: 12px;">08:30</td>
                                <td style="padding: 12px;">17:30</td>
                                <td style="padding: 12px;">ร่วมจัดกิจกรรมวันนักศึกษา</td>
                            </tr>
                            <tr style="border-bottom: 1px solid #eee; background-color: #f9f9f9;">
                                <td style="padding: 12px;">22 มี.ค. 2567</td>
                                <td style="padding: 12px;">08:30</td>
                                <td style="padding: 12px;">16:45</td>
                                <td style="padding: 12px;">เดินเอกสารระหว่างแผนก</td>
                            </tr>
                            <tr>
                                <td style="padding: 12px;">30 เม.ย. 2567</td>
                                <td style="padding: 12px;">08:30</td>
                                <td style="padding: 12px;">15:00</td>
                                <td style="padding: 12px;">สรุปงาน, ส่งมอบหน้าที่</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="gallery">
                    <div class="gallery-item">
                        <img src="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?ixlib=rb-4.0.3&auto=format&fit=crop&w=500" alt="เข้างาน">
                        <div class="gallery-caption">การเข้างานประจำวัน</div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="skills" class="slide">
            <div class="slide-header">
                ...
                <h2 class="slide-title">ทักษะที่ได้รับจากการฝึกงาน</h2>
            </div>
            <div class="slide-content">
                <h3>ทักษะส่วนบุคคล</h3>
                <ul>
                    <li>การจัดการเวลาและการจัดลำดับความสำคัญของงาน</li>
                    <li>ทักษะการสื่อสารกับบุคลากรและนักศึกษา</li>
                    <li>การแก้ไขปัญหาเฉพาะหน้าและการตัดสินใจ</li>
                    <li>ความรับผิดชอบและวินัยในการทำงาน</li>
                </ul>
                
                <h3>ความรู้ใหม่ๆ</h3>
                <ul>
                    <li>กระบวนการจัดกิจกรรมนักศึกษาในสถาบันการศึกษา</li>
                    <li>ระบบงานสารบรรณและการจัดการเอกสารราชการ</li>
                    <li>เทคนิคการออกแบบกิจกรรมที่สอดคล้องกับความต้องการของนักศึกษา</li>
                    <li>กฎระเบียบและข้อบังคับที่เกี่ยวข้องกับกิจกรรมนักศึกษา</li>
                </ul>
                
                <h3>สังคมใหม่ๆ</h3>
                <ul>
                    <li>การสร้างเครือข่ายกับบุคลากรในวิทยาลัย</li>
                    <li>การทำงานร่วมกับนักศึกษาจากหลายสาขาวิชา</li>
                    <li>การเรียนรู้วัฒนธรรมองค์กรในสถาบันการศึกษา</li>
                    <li>การสร้างสัมพันธภาพที่ดีกับเพื่อนร่วมงานและผู้บังคับบัญชา</li>
                </ul>
                
                <div class="gallery">
                    <div class="gallery-item">
                        <img src="https://images.unsplash.com/photo-1541746972996-4e0b0f43e02a?ixlib=rb-4.0.3&auto=format&fit=crop&w=500" alt="ทักษะ">
                        <div class="gallery-caption">การพัฒนาทักษะส่วนบุคคล</div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- Page 7: Achievements -->
        <section id="achievements" class="slide">
            <div class="slide-header">
                <div class="slide-number">6</div>
                <h2 class="slide-title">ผลสำเร็จหลัก</h2>
            </div>
            <div class="slide-content">
                <div class="stats-container">
                    <div class="stat-card">
                        <div class="stat-value">5</div>
                        <div class="stat-label">กิจกรรมนักศึกษา</div>
                        <p>ที่ได้มีส่วนร่วมในการจัด</p>
                    </div>
                    <div class="stat-card">
                        <div class="stat-value">120+</div>
                        <div class="stat-label">เอกสาร</div>
                        <p>ที่ได้จัดระบบและจัดการ</p>
                    </div>
                    <div class="stat-card">
                        <div class="stat-value">3</div>
                        <div class="stat-label">โครงการใหม่</div>
                        <p>ที่ได้เสนอแนะและช่วยพัฒนาขึ้น</p>
                    </div>
                </div>
                
                <h3>ผลสำเร็จเชิงคุณภาพ</h3>
                <ul>
                    <li>ได้รับคำชมจากหัวหน้าแผนกเรื่องความรับผิดชอบและความคิดสร้างสรรค์</li>
                    <li>สามารถพัฒนาระบบการจัดเก็บเอกสารให้มีประสิทธิภาพมากขึ้น</li>
                    <li>มีส่วนร่วมในการเพิ่มจำนวนผู้เข้าร่วมกิจกรรมนักศึกษาได้ 20%</li>
                    <li>สร้างเครือข่ายความร่วมมือกับนักศึกษาและบุคลากรในวิทยาลัย</li>
                </ul>
                
                <div class="gallery">
                    <div class="gallery-item">
                        <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&auto=format&fit=crop&w=500" alt="ผลสำเร็จ">
                        <div class="gallery-caption">ผลสำเร็จจากการฝึกงาน</div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="admin" class="slide">
            <div class="slide-header">
                ...
                <h2 class="slide-title">ระบบจัดการสำหรับผู้ดูแล</h2>
            </div>
            <div class="slide-content">
                <div class="login-section" id="loginSection">
                    <h3 class="login-title">เข้าสู่ระบบผู้ดูแล</h3>
                ...
                <div id="adminPanel" class="admin-panel">
                    <h3><i class="fas fa-user-cog"></i> แผงควบคุมสำหรับผู้ดูแลระบบ</h3>
                    <div class="admin-controls">
                        <button class="admin-btn" id="addSlideBtn"><i class="fas fa-plus"></i> เพิ่มสไลด์ใหม่</button>
                        <button class="admin-btn" id="addStudentBtn"><i class="fas fa-user-plus"></i> เพิ่มนักศึกษา</button>
                        <button class="admin-btn" id="viewDataBtn"><i class="fas fa-database"></i> ดูข้อมูลทั้งหมด</button>
                        <button class="admin-btn" id="downloadDbBtn"><i class="fas fa-download"></i> ดาวน์โหลดฐานข้อมูล</button>
                        <button class="admin-btn" id="resetDbBtn"><i class="fas fa-redo"></i> รีเซ็ตฐานข้อมูล</button>
                    </div>
                    
                    <div id="databasePanel" class="database-panel">
                        <div class="db-info">
                            <h4><i class="fas fa-database"></i> ชื่อฐานข้อมูล: internship_prasat_college.db</h4>
                            <p>สถานะ: <span id="dbStatus">กำลังทำงาน</span> | ขนาด: <span id="dbSize">กำลังคำนวณ...</span></p>
                            <p>จำนวนตาราง: <span id="tableCount">3</span> | เวอร์ชัน: 1.0.0</p>
                        </div>
                        
                        <div class="database-header">
                            <h4><i class="fas fa-table"></i> ข้อมูลการฝึกงานในฐานข้อมูล</h4>
                            <button class="admin-btn" id="refreshDbBtn"><i class="fas fa-sync-alt"></i> รีเฟรช</button>
                        </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    <h3>เกี่ยวกับวิทยาลัย</h3>
                    <p>วิทยาลัยการอาชีพปราสาท มุ่งผลิตกำลังคนอาชีวศึกษาที่มีคุณภาพ สอดคล้องกับความต้องการของตลาดแรงงานและชุมชน</p>
                    <p>ที่อยู่: 123 ถนนอาชีวศึกษา ตำบลปราสาท อำเภอปราสาท จังหวัดสุรินทร์ 32140</p>
                </div>
                
                <div class="footer-section">
                    <h3>ติดต่อเรา</h3>
                    <ul class="contact-list">
                        <li><i class="fas fa-phone"></i> 044-123456</li>
                        <li><i class="fas fa-envelope"></i> info@prasat-voc.ac.th</li>
                        <li><i class="fas fa-globe"></i> www.prasat-voc.ac.th</li>
                    </ul>
                ...
                <div class="footer-section">
                    <h3>แผนกที่เปิดสอน</h3>
                    <ul>
                        <li>แผนกช่างไฟฟ้า</li>
                        <li>แผนกช่างอิเล็กทรอนิกส์</li>
                        <li>แผนกช่างยนต์</li>
                        <li>แผนกธุรกิจบริการ</li>
                        <li>แผนกคอมพิวเตอร์ธุรกิจ</li>
                    </ul>
                </div>
            </div>
            
            <div class="copyright">
                &copy; 2024 วิทยาลัยการอาชีพปราสาท. สงวนลิขสิทธิ์ทุกประการ.
            </div>
        </div>
    </footer>
